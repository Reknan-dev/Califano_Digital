...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // Nota: i filtri "Gender" e "Vertical" non hanno dati corrispondenti
    // nel Google Sheet attuale (che contiene solo i follower). Se vuoi che
    // filtrino anche loro, va aggiunta una colonna GENDER/VERTICAL nel foglio
    // oppure un attributo data-gender / data-vertical manuale su ogni card.
  });
})();
